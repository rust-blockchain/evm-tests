...
#[test] fn st_attack() { run("res/ethtests/GeneralStateTests/stAttackTest") }
...
#[test] fn st_call_create_call_code() { run("res/ethtests/GeneralStateTests/stCallCreateCallCodeTest") }
...
#[test] fn st_mem_expanding_eip_150_calls() { run("res/ethtests/GeneralStateTests/stMemExpandingEIP150Calls") }
#[test] fn st_memory_stress() { run("res/ethtests/GeneralStateTests/stMemoryStressTest") }
#[test] fn st_memory() { run("res/ethtests/GeneralStateTests/stMemoryTest") }
#[test] fn st_non_zero_calls() { run("res/ethtests/GeneralStateTests/stNonZeroCallsTest") }
#[test] fn st_precompiled_contracts() { run("res/ethtests/GeneralStateTests/stPreCompiledContracts") }
...
#[test] fn st_random() { run("res/ethtests/GeneralStateTests/stRandom") }
#[test] fn st_random2() { run("res/ethtests/GeneralStateTests/stRandom2") }
#[test] fn st_recursive_create() { run("res/ethtests/GeneralStateTests/stRecursiveCreate") }
#[test] fn st_refund() { run("res/ethtests/GeneralStateTests/stRefundTest") }
#[test] fn st_return_data() { run("res/ethtests/GeneralStateTests/stReturnDataTest") }
...
#[test] fn st_shift() { run("res/ethtests/GeneralStateTests/stShift") }
